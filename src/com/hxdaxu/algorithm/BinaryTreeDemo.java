...
//		 preOrderTraverse(nodes[0]);
	...
	/**
	 * 给定一个二叉树，计算该二叉树的最大深度 最大深度为根节点到最远叶子节点的距离 如果二叉树为空，深度为0。根节点的深度为1
	 */
	 ...
	 * @param root
	 */
	public static void withoutRecursion(BiTNode root) {
	 ...
	 * @param root
	 */
	public static void withoutRecursion2(BiTNode root) {
		Stack<BiTNode> stack = new Stack();
		while (root != null || !stack.isEmpty()) {
			if (root != null) {
				root.visit();
